...
const badgeVariants = cva(
	"inline-flex items-center rounded-full px-5 py-1 text-gray-500 text-lg font-normal transition-colors focus:outline-hidden focus:ring-2 focus:ring-ring focus:ring-offset-2",
	{
		variants: {
			variant: {
