...
const VisionSection = () => {
	return (
		<section
			id="vision"
			className="w-full scroll-mt-24 bg-[#f8f9fa] px-5 pt-20 pb-16 md:pt-24 md:pb-16"
		>
			<div className="mx-auto flex w-full max-w-6xl flex-col">
				...
				<div className="flex flex-col md:flex-row items-center gap-10 lg:gap-[72px]">
					{/* Ilustrasi */}
					<div className="w-full md:w-1/2 flex justify-center">
						<img
							...
							className="w-4/5 sm:w-full max-w-[300px] sm:max-w-[420px] h-auto object-contain"
						/>
					</div>
					...
					<div className="w-full md:w-1/2 flex flex-col items-center text-center md:items-start md:text-left">
						...
						<h2 className="text-3xl sm:text-4xl md:text-[42px] font-bold text-[#004751] leading-snug md:leading-tight">
						...
						<p className="mt-5 md:mt-6 text-gray-600 text-base md:text-lg lg:text-[19px] leading-relaxed max-w-md md:max-w-none">
